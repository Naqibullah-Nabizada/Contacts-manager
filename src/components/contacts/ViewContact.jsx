            ...
            <section className="view-contact-intro p-3">
                <div className="container">
                    <div className="row text-center">
                        <p className="h3 fw-bold" style={{ color: CYAN }}>اطلاعات مخاطب</p>
                    </div>
                </div>
            </section>
                    ...
                    <>
                        {
                            Object.keys(contact).length > 0 && (
                                <section className="view-contact mt-3">
                                    <div className="container p-2" style={{ borderRadius: "1rem", background: CURRENTLINE }}>
                                        ...
                                        <div className="row my-2">
                                            <div className="col-6 mx-auto">
                                                <Link to={"/contacts"} className="btn" style={{ background: PURPLE }} >برگشت به صفحه اصلی</Link>
                                            </div>
                                        </div>
                                    </div>
                                </section>
